...
> **Disclaimer**: El código de la rama `Modelo Local` está diseñado para ejecutarse exclusivamente en local, con I/O de texto plano y no está optimizado para entornos de producción.
